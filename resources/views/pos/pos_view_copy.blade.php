        ...
        <div class="row ">
                    ...
                    <div class="card-header py-0 ">
                        <div class="row pt-5 ">
                            <div class="col-6 mx-auto">
                                <a href="Javascript:void(0)" class="btn w-100 bg-light-grey-blue btn-primary" id="running_order_button" onclick="loadOrdersByStatus('{{route('loadOrdersByStatus', ['running'])}}')">
                                    Running
                                </a>
                            </div>
                            <div class="col-6 mx-auto">
                        ...
                        <input type="text" name="" id="searchOrder" onkeyup="getOrderWithSearch(this)" class="form-control w-100 mmt-5" placeholder="Search here">
                    </div>
                    <div class="card-body pos-left-items pt-5 py-0" id="order-list-by-status">
                        @include('pos.partials.order')
                    </div>

                    <div class="card-footer p-0 main-left-p1 pt-5">
                        <div class="row btn-group mx-auto text-center">
                            <div class="col-12">
                                <button class="btn w-100 text-white bg-primary btn-sm mb-1 font-weight-bold vertical-btn-tab" data-target="#order_details_modal" onclick="getOrderDetails()">Order Details<i class="feather icon-info"></i></button>
                            </div>
                            <div class="col-12">
                                <button class="btn w-100 text-white bg-primary btn-sm mb-1 font-weight-bold vertical-btn-tab" data-toggle="modal" onclick="openInvoice()">Invoice</button>
                            </div>
                            <div class="col-12">
                                <button class="btn w-100 text-white bg-primary btn-sm mb-1 font-weight-bold vertical-btn-tab">Reprint KOT<i class="feather icon-printer"></i></button>
                            </div>
                            <div class="col-12">
                                <button class="btn w-100 text-white bg-primary btn-sm mb-1 font-weight-bold vertical-btn-tab">Cancel Order<i class="feather icon-ban"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-header py-0 pt-5">
                        <div class="row d-flex justify-content-around text-center">
                            <div class="col-3">
                                ...
                                <label for="dinein">
                                    <span class="btn w-100 bg-primary ml-auto font-weight-bold">
                                        Dine In
                            ...
                            <div class="col-3">
                                <button type="button" id="table_modal_button" data-toggle="modal" data-target="#table_modal" class="btn w-100 bg-primary ml-auto font-weight-bold">Table<i class="feather icon-grid"></i></button>
                            </div>
                        </div>
                        <div class="row">
            ...
            <div class="col-md-5 item_card main-pl0 main-card">
                <div class="card ">
                    ...
                    <div class="card-body main-left-p1 pt-5">
                        <div class="col-md-12">
                            <div class="row">
    ...
    <script type="text/javascript">
        ...
        function loadOrdersByStatus(url) {
            ...
            if (url.search(/running/i) > 0){
                $('#draft_order_button').removeClass('btn-primary');
                $('#running_order_button').addClass('btn-primary');
            }
            else{
                $('#running_order_button').removeClass('btn-primary');
                $('#draft_order_button').addClass('btn-primary');
            }
            $.ajax({
                url : url,
                dataType : 'json',
