                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{ route('profileUpdate', [Auth()->user()->name]) }}"><i
                                    class="feather icon-user"></i> Edit Profile</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{ route('changePassword', [Auth()->user()->name]) }}"><i
                                    class="feather icon-edit"></i> Change Password</a>
                            <div class="dropdown-divider"></div>
