                                        ...
                                        <div class="row align-items-center d-block">
                                            @if($data && Auth()->user()->user_img)
                                                <div class="form-group col-md-6 mb-2 mx-auto">
                                                    <img src="{{ asset('public/uploads/image/'.Auth()->user()->user_img)}}" alt="users avatar" width="120px" height="100px"
                                            ...
                                            <div class="form-group col-md-6 mb-2 mx-auto">
                                                ...
                                                <input type="email" id="email" class="form-control" placeholder="janedoe@example.com" name="email" value="{{$data ? Auth()->user()->email : ''}}">
                                            </div>
                                            <div class="form-group col-md-6 mb-2 mx-auto">
