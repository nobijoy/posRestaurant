...
@section('body')
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-1 col-4 mb-1">
                <h3 class="content-header-title">
                    <a href="#" data-toggle="modal"data-target="#add_return" class="btn btn-primary">Purchase Return</a>
                </h3>
            </div>
        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered" id="action-table">
                                            ...
                                            <tr>
                                                ...
                                                <td>12.00</td>
                                                <td>
                                                    <a data-toggle="modal"data-target="#edit_return" data-target-id=""
                                                       data-name="" >
        ...
        <!-- Start Add Modal -->
        <div class="modal fade text-left" id="add_return" tabindex="-1" role="dialog"
             aria-labelledby="myModalLabel35" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="myModalLabel35">Add Return Purchase Info</h3>
        ...
        <!-- Start Edit Modal -->
        <div class="modal fade text-left" id="edit_return" tabindex="-1" role="dialog"
             aria-labelledby="myModalLabel35" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="myModalLabel35">Edit Return Purchase Info</h3>
                        <button type="button" class="close text-danger" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
@section('script')
    <script type="text/javascript">
        $("#edit_return").on("show.bs.modal", function (e) {
        ...
        $("#edit_return").on("hide.bs.modal", function (e) {
            location.reload();
        });
    </script>
@endsection
