                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" method="post" action="{{route('waste.update', [$data->id])}}" enctype="multipart/form-data">@csrf
                                        <div class="form-body">
...
@section('script')
    <script type="text/javascript">
        let addedIngradient = {!! $data->ingredients !!};
        let ingredientSl = 0;
            ...
            $("#ingredients").on("change", function(){
                ...
                if (id != ''){
                    ...
                    var newRow = '<tr id="ingredient_row_'+ingredient_details[0] + '">' +
                        ...
                        '<input type="number" class="form-control" step="any" min="0" onkeyup="lostCost(this)" data-check_id="'+ingredient_details[0]+'" data-unit_price="'+ingredient_details[3]+'" name="quantity[]" placeholder="Waste Amount/Quantity" aria-describedby="basic-addon_'+ingredient_details[0] + '" required>' +
