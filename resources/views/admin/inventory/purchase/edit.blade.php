            ...
            <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="#">Edit Purchase Info</a>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-card-center">Update Purchase Info</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" method="post" action="{{ route ('purchase.update',[$data->id]) }}" enctype="multipart/form-data">@csrf
                                        <div class="form-body">
...
@section('script')
    <script type="text/javascript">
        let addedIngradient = <?php echo json_encode($purId); ?>;
        let ingredientSl = 0;
