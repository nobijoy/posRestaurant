        ...
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-1">
                <h3 class="content-header-title">
                    <a href="{{ route ('modifiers')}}" class="btn btn-primary">Modifiers List<i class="fa fa-eye"></i></a>
                </h3>
            </div>
            <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="#">Edit Modifiers</a>
                        </li>
                    </ol>
                </div>
            </div>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" method="post" action="" enctype="multipart/form-data">@csrf
                                        <div class="form-body">
                                            @include('admin.pos.modifiers.form')
                                        </div>

                                        <div class="form-actions text-right">
                                            <a href="{{ route ('modifiers')}}" class="btn btn-warning mr-1">
