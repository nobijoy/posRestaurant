...
<div class="content-wrapper">
                                                        ...
                                                        <td>
                                                            @if($data->is_active == 1)
                                                                ...
                                                                <button type="button" class="btn btn-icon btn-outline-danger btn-sm" title="Inactive"
                                                                        onclick="deleteData('{{ route('ingredientUnit.delete', [$data->id]) }}')">
                                                                    <i class="fa fa-trash" aria-hidden="true"></i>
                                                                </button>
                                                            @else
                                                                <button type="button" class="btn btn-icon btn-outline-primary btn-sm" title="Restore"
                                                                        onclick="restoreData('{{ route('ingredientUnit.restore', [$data->id]) }}')">
    ...
    <div class="modal fade text-left" id="addcategory" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route ('ingredientUnit.store') }}" method="post" class="clearForm form" enctype="multipart/form-data">@csrf
    ...
    <div class="modal fade text-left" id="editcategory" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="myModalLabel35">Edit Ingredient Unit</h3>
                    <button type="button" class="close text-danger" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route ('ingredientUnit.update') }}" method="post" class="clearForm form" enctype="multipart/form-data">@csrf
                    <div class="modal-body">
